 ...
 */
?>
<!-- wp:group {"align":"full","style":{"border":{"width":"1px"},"spacing":{"blockGap":"0"}},"borderColor":"black","layout":{"type":"grid","columnCount":7,"minimumColumnWidth":null}} -->
<div class="wp-block-group alignfull has-border-color has-black-border-color" style="border-width:1px"><!-- wp:site-title {"style":{"border":{"top":{"width":"0px","style":"none"},"right":{"width":"1px","color":"var:preset|color|primary"},"bottom":{"width":"1px"},"left":{"width":"0px","style":"none"}},"layout":{"columnSpan":3},"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}},"typography":{"textTransform":"uppercase"}}} /-->
...
<!-- wp:navigation {"ref":61,"overlayMenu":"always","style":{"spacing":{"margin":{"top":"0"}},"layout":{"selfStretch":"fixed","flexSize":"5rem"}},"layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"center","orientation":"horizontal"}} /-->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" style="border-width:1px;border-radius:0px">></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:paragraph {"align":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}},"border":{"top":{"width":"1px"}}},"fontSize":"x-large"} -->
<p class="has-text-align-center has-x-large-font-size" style="border-top-width:1px;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><?php esc_html_e( 'Change Brightness', 'glaser' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->